...
The Go server serves the built frontend from `frontend/dist` when that build is present. The classic server-rendered views remain available at the root paths.
