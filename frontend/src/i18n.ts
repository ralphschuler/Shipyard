...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    updatesCheckTitle: "Update check", updatesCheckDescription: "Only approved GitHub releases on the target branch are considered.", updatesManualTitle: "Check for updates now", updatesReadOnly: "This read-only check does not install anything.", updatesCheckNow: "Check for updates now", updatesChecking: "Checking …", updatesLastChecked: "Last checked", updatesCurrentVersion: "Current version", updatesGoToolchain: "Go toolchain", updatesStatus: "Comparison status", updatesUpToDate: "System is up to date", updatesAvailable: "Update available", updatesFailed: "Check failed", updatesCheckFailed: "The update check could not be completed.", notAvailable: "not available",
  },
};
